<template>
	<view>
		...
		<view @touchmove.stop="" class="uni-popup" :class="'uni-popup-' + position + ' ' + 'uni-popup-' + mode" v-show="show">
			{{ msg }}
			<slot></slot>
			<view @touchmove.stop="" v-if="position === 'middle' && mode === 'insert'" class=" uni-icon uni-icon-close" :class="{
