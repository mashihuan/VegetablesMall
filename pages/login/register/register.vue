<template>
	<view class="content">
		...
		<clickButton text="立即注册" :buttonClick="buttonClick"></clickButton>
		<!-- <thirdLogin :thirdLoginClick="thirdLoginClick"></thirdLogin> -->
	</view>
</template>
...
export default {
	...
	methods: {
		...
		async buttonClick () { // 立即注册
			let result = await register({
				mobile: this.phone,
				captcha: this.sms,
				password: this.pwd,
				confirm_pwd: this.pwd2
			})
			console.log(result)
